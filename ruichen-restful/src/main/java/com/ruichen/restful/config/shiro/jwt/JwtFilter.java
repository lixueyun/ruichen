...
public class JwtFilter extends BasicHttpAuthenticationFilter {
    ...
    private boolean refreshToken(ServletRequest request, ServletResponse response) {
        ...
        if (redisTemplate.hasKey(ShiroConstant.PREFIX_SHIRO_REFRESH_TOKEN + account)) {
            // Redis中RefreshToken还存在，获取RefreshToken的时间戳
            String currentTimeMillisRedis = (String) redisTemplate.opsForValue().get(ShiroConstant.PREFIX_SHIRO_REFRESH_TOKEN + account);
